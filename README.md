...
### Confusion Matrix
Beautiful heatmap showing True Positives, False Positives, True Negatives, and False Negatives with percentage breakdown and professional "Blues" colormap.

![Confusion Matrix](https://raw.githubusercontent.com/jameskoero/titanic-survival-prediction/main/confusion_matrix.png)

### ROC Curve
ROC curve with AUC score (0.86) prominently displayed, includes random classifier baseline for reference and shaded area under the curve.

![ROC Curve](https://raw.githubusercontent.com/jameskoero/titanic-survival-prediction/main/roc_curve.png)

### Feature Distribution
2x2 subplot grid showing distributions of key features by survival outcome:
- **Sex**: Gender distribution by survival
- **Age**: Age distribution by survival
- **Pclass**: Passenger class by survival
- **Fare**: Ticket fare by survival
...
### Feature Importance
Horizontal bar chart displaying model coefficients showing feature impact on predictions:
- Red bars = Negative impact (reduced survival chance)
- Green bars = Positive impact (increased survival chance)

![Feature Importance](https://raw.githubusercontent.com/jameskoero/titanic-survival-prediction/main/feature_importance.png)
